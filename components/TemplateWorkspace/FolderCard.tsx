...
export function FolderCard({ folder, onClick, onRename, onDelete, canManage = true }: FolderCardProps) {
            ...
            >
                <CardContent className="p-4">
                    <div className="flex items-center gap-3">
                        ...
                        {/* Name / rename input */}
                        <div className="flex-1 min-w-0" onClick={(e) => renaming && e.stopPropagation()}>
                            {renaming ? (
                                <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                                    ...
                                    <Button
                                        ...
                                        variant="ghost"
                                        className="h-7 w-7 shrink-0"
                                        onClick={(e) => { e.stopPropagation(); setRenaming(false); setRenameName(folder.name); }}
                                        disabled={busy}
                                    >
            ...
            <AlertDialog open={confirmDelete} onOpenChange={setConfirmDelete}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This folder must be empty before it can be deleted. Templates inside must be moved first.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
