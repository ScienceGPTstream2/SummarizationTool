      ...
      <div className="w-full lg:w-[40%] flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-sm">
          ...
          <Button
            variant="outline"
            disabled
            className="w-full h-12 text-[15px] font-medium border-slate-200 text-slate-600 rounded-xl hover:bg-slate-50 disabled:opacity-60 disabled:cursor-not-allowed"
          >
