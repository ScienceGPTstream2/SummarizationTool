export const justTablesEpiTemplate = {
  "studyType": "Just Tables Epi",
  "displayName": "Just Tables Epi",
  "entities": [
    {
      "name": "Just Tables Epi",
  ...
  "summaryPrompt": "Take the extracted entities and put them into a single cohesive table. Do not change any of the extracted entities."
};
