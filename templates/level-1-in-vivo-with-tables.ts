export const level1InVivoWithTablesTemplate = {
  "studyType": "level-1-in-vivo",
  "displayName": "Level-1-In-Vivo with Tables",
  "entities": [
    {
      "name": "Study Author(s)",
