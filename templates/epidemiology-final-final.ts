export const epidemiologyFinalFinalTemplate = {
  ...
  "summaryPrompt": "Take the extracted entities and put them into a single cohesive paragraph and table. Do not change any of the extracted entities."
};
