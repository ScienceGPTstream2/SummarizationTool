export const epidemiologyFinalFinalTemplate = {
  studyType: "EPIDEMIOLOGY FINAL FINAL",
  displayName: "EPIDEMIOLOGY FINAL FINAL",
  entities: [
    {
      name: "Study Author(s)",
      prompt:
